...
# See the License for the specific language governing permissions and
# limitations under the License.
from nvflare.app_common.xgb.he.cipher import Cipher


class Aggregator:
    def __init__(self, cipher: Cipher, initial_value=0):
        self.cipher = cipher
    ...
    def _update_aggregation(self, gh_values, sample_bin_assignment, sample_id, aggr):
        ...
        if current_value == 0:
            ...
            aggr[bin_id] = self.cipher.add(current_value, sample_value)
