...
from nvflare.app_common.cwf.common import Constant, ModelType, topic_for_end_workflow
...
class CrossSiteEvalClientController(ClientSideController):
    ...
    def process_config(self, fl_ctx: FLContext):
        start_client = self.get_config_prop(Constant.START_CLIENT)
        ...
        if start_client == self.me and eval_global:
            ...
            if not inventory:
                return make_reply(Constant.RC_NO_GLOBAL_MODELS)
