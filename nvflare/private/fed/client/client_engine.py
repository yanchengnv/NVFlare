...
from nvflare.apis.fl_constant import JobConfigStdVarName, MachineStatus, SystemComponents, WorkspaceConstants
    ...
    def __init__(self, client: FederatedClient, args, rank, workers=5):
        ...
        self.fl_ctx_mgr = FLContextManager(
            ...
            private_stickers={
                ...
                JobConfigStdVarName.SECURE_TRAIN: self.client.secure_train,
